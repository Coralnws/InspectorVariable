// src/lib.rs
/*
 * Core library for InspectorVariable
 */
...
#[derive(Debug)]
pub struct InspectorVariableProcessor {
    verbose: bool,
    processed_count: usize,
}

impl InspectorVariableProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting InspectorVariable processing");
    
    let mut processor = InspectorVariableProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = InspectorVariableProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = InspectorVariableProcessor::new(false);
